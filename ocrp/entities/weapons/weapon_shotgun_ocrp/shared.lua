...
-- 	bullet.Callback	= function ( a, b, c ) BulletPenetration( 0, a, b, c ) end 	-- CALL THE FUNCTION BULLETPENETRATION
	...
	if trace.Entity:GetClass() == "prop_door_rotating"  and (SERVER) then	
		if !self.Owner:HasSkill("skill_picking",7) and !self.Owner:HasSkill("skill_rob",6) then
            self.Owner:Hint("You need lockpicking 7 and robbery 6 to shoot down doors.")
            return
		end
